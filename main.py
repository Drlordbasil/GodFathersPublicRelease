    ...
    if match:
        ...
        try:
            ...
            model.generate(f"""
                        ...
                        <imports go here>
                        \n
                        # initialization and other features that need loaded like loggers and AI models\n
                        <code to initilize>
                        # Main core core classes\n
                        <at least 3 core classes with 10 functions within each fully generated by you>\n
                        # main loops\n
                        <main loop with if main>\n
                        '''
                        \n
                    # Every file must be single program style utilising threading, docstrings, and autonomous programming.\n
                    # if you include anything in your response thats not valid code, it must be a docstring or inline comment that explains the proper logic below it.\n
                    Code you need to reformat:\n
                    '''python\n
                    {code}\n
                    '''\n

                    # ensure no syntax errors ever.
                    # ensure no name errors.
...
if __name__ == "__main__":
    ...
    print("2. Enter an idea and run the script")
    print("3. Fix a local Python file (not working properly)")
    print("4. Fix a Python file on GitHub(not working properly)")
    ...
    if option == "1":
        ...
        main = IdeaGenAndGitUploader(os.getenv("OPENAI_API_KEY"), os.getenv("GITHUB_API_KEY"), 'history.json')
        main.run(idea)
